...
coefs_df <- read_excel(glue("{models_coefs_dsg_dir}/models_coefficients_dsg.xlsx"))
head(coefs_df)
...
write_xlsx(merged_df, glue("{models_coefs_dsg_dir}/models_coefficients_dsg.xlsx"))
...
write_xlsx(summary_stats, glue("{models_coefs_dsg_dir}/models_coeffcients_dsg_summary_stats.xlsx"))
...
gtsave(publication_table, file = glue("{models_coefs_dsg_dir}/models_coeffcients_dsg_summary_stats.png"), 
