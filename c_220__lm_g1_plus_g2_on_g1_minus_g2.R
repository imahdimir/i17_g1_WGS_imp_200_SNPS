...
models_sum_dir <- glue("{out_dir}/lm_g1_plus_g2_on_g1_minus_g2_models_summary")
...
fit_and_save_models <- function(data, rsid_value) {
  ...
  model <- lm(g1_plus_g2 ~ g1_minus_g2, data = filtered_data)
  
  output_fp <- glue("{models_sum_dir}/{quality}_{rsid_value}.txt")
...
write_xlsx(combined_model_metrics_df, glue("{out_dir}/lm_g1_plus_g2_on_g1_minus_g2_models_metrics/lm_g1_plus_g2_on_g1_minus_g2_coefficients.xlsx"))
write_xlsx(combined_coef_dfs, glue("{out_dir}/lm_g1_plus_g2_on_g1_minus_g2_models_coefficients/lm_g1_plus_g2_on_g1_minus_g2_models_metrics.xlsx"))
